...
//
//    public Date[] getIssueAndDueDate(String memberId, String bookId) {
//        try (Connection con = ConnectionProvider.getCon();
//             PreparedStatement pst = con.prepareStatement("SELECT issue_date, due_date FROM issue WHERE member_id = ? AND book_id = ?")) {
...
//                    return new Date[]{issueDate, dueDate};
//                }
//            }
...
//    }
//
//    public boolean returnBook(String memberId, String bookId, String returnStatus) {
//        try (Connection con = ConnectionProvider.getCon();
//             PreparedStatement pst = con.prepareStatement("UPDATE issue SET returnStatus = ?, returnDate = ? WHERE memberId = ? AND bookId = ?")) {
